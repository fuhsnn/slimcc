...
static int char_width(uint32_t c) {
  ...
  if (in_range(c, range1, sizeof(range1) / sizeof(UTF32Range)))
    return 0;

  static UTF32Range range2[] = {
  ...
  if (in_range(c, range2, sizeof(range2) / sizeof(UTF32Range)))
    return 2;
  return 1;
}
