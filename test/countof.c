...
int vla(int i) {
  ...
  SASSERT(11 == _Countof arr);
  ASSERT(24, _Countof *arr);
  SASSERT(33 == _Countof **arr);
  ...
  tarr A;
  ASSERT(4, _Countof A);
  SASSERT(33 == _Countof *A);

  ASSERT(4, _Countof(tarr));

  extern int fn_not_to_be_called(int);
  SASSERT(30 == _Countof(int[30][fn_not_to_be_called(i = 90)]));
...
int main(void) {
  ...
  SASSERT(7 == _Countof str1);
  SASSERT(4 == _Countof "foo");
